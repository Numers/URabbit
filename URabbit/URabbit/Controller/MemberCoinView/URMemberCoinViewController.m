...
#import "URMemberCoinViewController.h"

@interface URMemberCoinViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong) IBOutlet UITableView *tableView;
@property(nonatomic, strong) IBOutlet UILabel *leftCoinLabel;
@end

@implementation URMemberCoinViewController
