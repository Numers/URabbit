//
//  URMemberCompositonViewController.m
//  URabbit
//
...
@interface URMemberCompositonViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,WSLWaterFlowLayoutDelegate>
{
...
@implementation URMemberCompositonViewController
...
- (void)viewDidLoad {
    ...
    [collectionView registerClass:[URMemberCompositonCollectionViewCell class] forCellWithReuseIdentifier:memberCompositionCollectionViewCellIdentify];
...
{
    URMemberCompositonCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:memberCompositionCollectionViewCellIdentify forIndexPath:indexPath];
...
{
    Composition *compositon = [dataSource objectAtIndex:indexPath.row];
    URMemberCompositionDetailsViewController *memberCompositionDetailsVC = [[URMemberCompositionDetailsViewController alloc] initWithComposition:compositon];
