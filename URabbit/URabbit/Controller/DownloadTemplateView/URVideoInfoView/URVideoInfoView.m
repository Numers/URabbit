...
@implementation URVideoInfoView
-(instancetype)initWithVideoSize:(CGSize)size frame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [videoNameLabel setTextColor:[UIColor colorFromHexString:@"#333333"]];
        ...
        [videoDurationLabel setTextColor:[UIColor colorFromHexString:@"#333333"]];
        ...
        [videoDescLabel setTextColor:[UIColor colorFromHexString:@"#999999"]];
...
-(void)setHomeTemplate:(HomeTemplate *)homeTemplate
{
    ...
    [AppUtils drawDashLine:lineView lineLength:self.frame.size.width - 30 lineSpacing:0 lineColor:[UIColor colorFromHexString:@"#F5F5F5"]];
