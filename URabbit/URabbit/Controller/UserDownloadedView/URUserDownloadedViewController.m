//
//  URUserDownloadedViewController.m
//  URabbit
//
...
#import "URUserDownloadedCollectionViewCell.h"
...
@interface URUserDownloadedViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,WSLWaterFlowLayoutDelegate>
{
...
@implementation URUserDownloadedViewController
...
- (void)viewDidLoad {
    ...
    [collectionView registerClass:[URUserDownloadedCollectionViewCell class] forCellWithReuseIdentifier:userDownloadedCollectionViewCellIdentify];
...
{
    URUserDownloadedCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:userDownloadedCollectionViewCellIdentify forIndexPath:indexPath];
