//
//  URCategoryPageViewController.m
//  URabbit
//
...
@implementation URCategoryPageViewController
...
- (void)viewDidLoad {
    ...
    [collectionView registerClass:[URCategoryPageCollectionViewCell class] forCellWithReuseIdentifier:categoryCollectionViewCellIdentify];
...
{
    URCategoryPageCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:categoryCollectionViewCellIdentify forIndexPath:indexPath];
