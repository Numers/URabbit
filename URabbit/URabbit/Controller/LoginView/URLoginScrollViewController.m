...
@interface URLoginScrollViewController ()<UTLoginViewProtocol>
{
    URLoginViewController *loginVC;
    TPKeyboardAvoidingScrollView *scrollView;
}
@end

@implementation URLoginScrollViewController
