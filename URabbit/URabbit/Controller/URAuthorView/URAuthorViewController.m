...
#import "URAuthorCollectionViewCell.h"
...
@interface URAuthorViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,WSLWaterFlowLayoutDelegate>
{
    Author *currentAuthor;
    URAuthorHeadView *headView;
...
@implementation URAuthorViewController
...
- (void)viewDidLoad {
    ...
    [collectionView registerClass:[URAuthorCollectionViewCell class] forCellWithReuseIdentifier:authorCollectionViewCellIdentify];
    [collectionView registerClass:[URAuthorHeadView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:authorHeadViewIdentify];
    [collectionView registerClass:[URAuthorCollectionFootReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:authorFootViewIdentify];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        URAuthorHeadView *headView = [collectionView dequeueReusableSupplementaryViewOfKind:kind withReuseIdentifier:authorHeadViewIdentify forIndexPath:indexPath];
        if (headView) {
            [headView setAuthor:currentAuthor];
        }
        return headView;
    }else{
        URAuthorCollectionFootReusableView *footView = [collectionView dequeueReusableSupplementaryViewOfKind:kind withReuseIdentifier:authorFootViewIdentify forIndexPath:indexPath];
        return footView;
    }
}
...
{
    URAuthorCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:authorCollectionViewCellIdentify forIndexPath:indexPath];
