...
@class Member;
@protocol URUserCenterHeadViewProtocol <NSObject>
-(void)gotoLoadedView;
-(void)gotoSaveView;
-(void)gotoDraftView;
-(void)gotoLoginView;
@end
@interface URUserCenterHeadView : UIView
{
...
@property(nonatomic, strong) id<URUserCenterHeadViewProtocol> delegate;
