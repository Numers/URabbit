...
@interface URHomeRecommendView()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
    UIView *headerView;
...
@end
@implementation URHomeRecommendView
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [collectionView registerClass:[URHomeRecommendCollectionViewCell class] forCellWithReuseIdentifier:homeRecommendCollectionViewCellIdentify];
...
{
    URHomeRecommendCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:homeRecommendCollectionViewCellIdentify forIndexPath:indexPath];
