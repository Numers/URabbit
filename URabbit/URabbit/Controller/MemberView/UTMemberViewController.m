...
- (void)viewDidLoad {
    ...
    [_tableView registerClass:[UTMemberTableViewCell class] forCellReuseIdentifier:memberTableViewCellIdentify];
...
-(void)requestVIPPriceList
{
    ...
    [[UTUserVipNetworkAPIManager shareManager] requestVIPPriceCallback:^(NSNumber *statusCode, NSNumber *code, id data, id errorMsg) {
        if (data) {
...
{
    UTMemberTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:memberTableViewCellIdentify forIndexPath:indexPath];
