//
//  URMemberScrollViewController.m
//  URabbit
//
...
@interface URMemberScrollViewController ()<MemberViewProtocol>
{
    URMemberViewController *memberVC;
    Member *currentHost;
    BOOL isPushIn;
}
...
@implementation URMemberScrollViewController
-(instancetype)init
{
    self = [super init];
    if (self) {
...
-(void)clickOpenMemeberButton
{
    ...
    if (currentHost) {
        [[URUserVipNetworkAPIManager shareManager] requestBuyVipBillInfoWithPriceId:price.priceId channel:WechatPay callback:^(NSNumber *statusCode, NSNumber *code, id data, id errorMsg) {
