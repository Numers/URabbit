...
@interface URImageHanderManager()
{
...
@implementation URImageHanderManager
+(instancetype)shareManager
{
    static URImageHanderManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[URImageHanderManager alloc] init];
    });
    return manager;
}
