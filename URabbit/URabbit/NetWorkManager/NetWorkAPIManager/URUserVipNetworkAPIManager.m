...
@implementation URUserVipNetworkAPIManager
+(instancetype)shareManager
{
    static URUserVipNetworkAPIManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[URUserVipNetworkAPIManager alloc] init];
    });
    return manager;
}
