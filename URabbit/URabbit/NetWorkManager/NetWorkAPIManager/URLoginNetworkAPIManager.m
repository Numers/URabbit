...
@implementation URLoginNetworkAPIManager
+(instancetype)shareManager
{
    static URLoginNetworkAPIManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[URLoginNetworkAPIManager alloc] init];
    });
    return manager;
}
