...
@implementation UTAuthorNetworkAPIManager
+(instancetype)shareManager
{
    static UTAuthorNetworkAPIManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[UTAuthorNetworkAPIManager alloc] init];
    });
    return manager;
}
