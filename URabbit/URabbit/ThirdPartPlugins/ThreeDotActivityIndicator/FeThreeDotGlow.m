...
-(void) initThreeDot
{
    ...
    _containerDotLayer.frame = CGRectMake(0, 0, 30, 30);
    ...
    for (NSInteger i = 0; i < 4; i++)
    {
        ...
        switch (i) {
            case 0:
            {
                frame = CGRectMake(0.5, 0.5, 10, 10);
                break;
            }
            case 1:
            {
                frame = CGRectMake(0, 19.5, 10, 10);
                break;
            }
            case 2:
            {
                frame = CGRectMake(19.5, 19.5, 10, 10);
                break;
            }
            case 3:
            {
                frame = CGRectMake(19.5, 0.5, 10, 10);
                break;
            }
            default:
                break;
...
-(void) initAniamtion
{
    ...
    _colorGlowAnimation.keyTimes = @[[NSNumber numberWithFloat:0.0f],
                                ...
                                [NSNumber numberWithFloat:1.0f]];
    _colorGlowAnimation.values = @[(id)[UIColor colorWithHexCode:@"#DFEFFF"].CGColor,
                              (id)[UIColor colorWithHexCode:@"#B1D7FF"].CGColor,
                              (id)[UIColor colorWithHexCode:@"#8DC5FF"].CGColor,
                              (id)[UIColor colorWithHexCode:@"#B1D7FF"].CGColor,
                              (id)[UIColor colorWithHexCode:@"#DFEFFF"].CGColor];
    ...
    _colorDotAnimation.keyTimes = @[[NSNumber numberWithFloat:0.0f],
                                ...
                                [NSNumber numberWithFloat:0.75f],
                                [NSNumber numberWithFloat:1.0f]];
    _colorDotAnimation.values = @[(id)[UIColor colorWithHexCode:@"#DFEFFF"].CGColor,
                                  (id)[UIColor colorWithHexCode:@"#B1D7FF"].CGColor,
                                  (id)[UIColor colorWithHexCode:@"#8DC5FF"].CGColor,
                                  (id)[UIColor colorWithHexCode:@"#B1D7FF"].CGColor,
                                  (id)[UIColor colorWithHexCode:@"#DFEFFF"].CGColor];
